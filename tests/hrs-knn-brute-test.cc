...
int main() {
  ...
  //
  // Larger test cases are provided further down (uncomment them when you
  // are ready).
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  // Digit10
  //------------------------------------------------------------------------
  // Digit10 should predict correctly with a training set of 5 images
...

  {
    ...
    HandwritingRecSysKnnBruteForce hrs;                  // Declare the hrs
  ...
  // Digit9
  //------------------------------------------------------------------------
  // Digit9 should predict correctly with a training set of 20 images
...

  {
    ...
    HandwritingRecSysKnnBruteForce hrs;
...

  {
    ...
    std::cout << "Accuracy (brute_force, mnist_t10_i10): ";
    std::cout << accuracy << std::endl;

    // Accuracy should be...

    double accuracy_expected = 0.6;
...

  {
    ...
    std::cout << "Accuracy (brute_force, mnist_t600_i100): ";
    std::cout << accuracy << std::endl;

    // Accuracy should be...

    double accuracy_expected = 0.83;

    UTST_ASSERT_DOUBLE_EQ( accuracy / accuracy_expected, 1.0, accuracy_expected );
  }
